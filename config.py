...
# 模型价格
MODEL_PRICE = {
    'gpt-3.5-turbo':{'completion_price':0.002*(10**-3),'prompt_price':0.0015*(10**-3)},
    'gpt-3.5-turbo-16k':{'completion_price':0.004*(10**-3),'prompt_price':0.003*(10**-3)}
}
...
AVAIL_LLM_MODELS = ["gpt-3.5-turbo", "gpt-3.5-turbo-16k", "api2d-gpt-3.5-turbo", "gpt-4", "api2d-gpt-4", "chatglm", "moss", "newbing", "newbing-free", "stack-claude"]
