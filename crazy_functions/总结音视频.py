...
def AnalyAudio(parse_prompt, file_manifest, llm_kwargs, chatbot, history, username):
    ...
    for index, fp in enumerate(file_manifest):
        ...
        for j, i in enumerate(voice):
            ...
            # 可调查有关whisper的返回值数据，修改此程序对音频处理进行计价
...
@CatchException
def 总结音视频(txt, llm_kwargs, plugin_kwargs, chatbot, history, system_prompt, WEB_PORT, username):
    import glob, os
    ...
    yield from AnalyAudio(parse_prompt, file_manifest, llm_kwargs, chatbot, history, username)
