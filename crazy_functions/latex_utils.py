...
def 编译Latex差别(chatbot, history, main_file_original, main_file_modified, work_folder_original, work_folder_modified, work_folder, username):
    import os, time
    ...
    while True:
        ...
        if modified_pdf_success:
            ...
            promote_file_to_downloadzone(result_pdf,username)
            return True # 成功啦
        else:
