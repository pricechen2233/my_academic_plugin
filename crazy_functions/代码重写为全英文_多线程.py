...
from main import tokencreator,gr
...
@CatchException
def 全项目切换英文(txt, llm_kwargs, plugin_kwargs, chatbot, history, sys_prompt, web_port, request:gr.Request):
    # 第0步：校验用户身份
    ...
    os.makedirs('gpt_log/'+ username+ '/crazy_functions', exist_ok=True)
    ...
    for index, h in enumerate(handles):
        ...
        where_to_relocate = f'gpt_log/{username}/{fp}'
    ...
    # 第10步：备份一个文件
    res = write_results_to_file(history, username)
